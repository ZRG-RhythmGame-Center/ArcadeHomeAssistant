...
public sealed class AgentSettingsServiceTests : IDisposable
{
    ...
    public async Task UpdateAsync_WithDuplicateLauncherKey_FailsWithoutWritingConfig()
    {
        ...
        var launcher = new LauncherSettingsDto(
            ...
            new[]
            {
                new LauncherItemSettingsDto("a", "A", "echo a", null, "A", 1, true),
                new LauncherItemSettingsDto("b", "B", "echo b", null, "a", 2, true)
            });
    ...
    public async Task UpdateAsync_WithValidLauncher_PersistsUserConfig()
    {
        ...
        var launcher = new LauncherSettingsDto(
            ...
            1080,
            1920,
            new[] { new LauncherItemSettingsDto("mai", "maimai", "echo mai", null, "M", 1, true) });
