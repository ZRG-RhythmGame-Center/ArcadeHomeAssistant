...
public static class DeviceEndpoints
{
    public static IEndpointRouteBuilder MapDeviceEndpoints(this IEndpointRouteBuilder app)
    {
        app.MapGet("/api/audio/devices",
            async Task<Results<Ok<IReadOnlyList<DeviceResponse>>, JsonHttpResult<ErrorResponse>>> (
        ...
        app.MapPost("/api/audio/default-device",
            async Task<Results<Ok<IReadOnlyList<DeviceResponse>>, NotFound<ErrorResponse>, BadRequest<ErrorResponse>,
    ...
    {
        return devices.Select(device => new DeviceResponse(
                device.Id.ToString(),
                device.Name,
                device.IsDefault,
