    ...
    IReadOnlyList<LauncherItemSettingsDto> Items)
{
    ...
    public static LauncherSettingsDto FromOptions(LauncherOptions options)
    {
...
{
    public FileRoot ToFileRoot()
    {
        return new FileRoot(Id, Name, Path, ReadOnly);
    }

    public static FileRootSettingsDto FromFileRoot(FileRoot root)
    {
        return new FileRootSettingsDto(root.Id, root.Name, root.Path, root.ReadOnly);
    }
}
