...
- [Program.cs](../../services/windows-agent/src/MaimaiHomeAgent/Program.cs)
- [MaimaiHomeAgent.csproj](../../services/windows-agent/src/MaimaiHomeAgent/MaimaiHomeAgent.csproj)
- [appsettings.json](../../services/windows-agent/src/MaimaiHomeAgent/appsettings.json)
- [launchSettings.json](../../services/windows-agent/src/MaimaiHomeAgent/Properties/launchSettings.json)
- [MaimaiHomeAgent.http](../../services/windows-agent/src/MaimaiHomeAgent/MaimaiHomeAgent.http)
...
[appsettings.json](../../services/windows-agent/src/MaimaiHomeAgent/appsettings.json) 与 [launchSettings.json](../../services/windows-agent/src/MaimaiHomeAgent/Properties/launchSettings.json) 都显式设为：
...
[appsettings.json](../../services/windows-agent/src/MaimaiHomeAgent/appsettings.json) 新增 `RemoteShutdown` 段：
...
- [Program.cs](../../services/windows-agent/src/MaimaiHomeAgent/Program.cs) 启动时会把 `%LOCALAPPDATA%` 展开成真实路径，再覆盖 Serilog 文件 sink 的 `path`
...
- [appsettings.json](../../services/windows-agent/src/MaimaiHomeAgent/appsettings.json) 的 `Discovery` 段
...
[MaimaiHomeAgent.csproj](../../services/windows-agent/src/MaimaiHomeAgent/MaimaiHomeAgent.csproj) 当前新增的关键依赖：
